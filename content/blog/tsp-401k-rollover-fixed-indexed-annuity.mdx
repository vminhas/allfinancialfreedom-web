...
You do not need to win every year. **You need to stop losing.** Because when you eliminate the down years, you stop the compounding damage — and you stop selling income at the worst possible time.
...
**Who this matters to:** retirees who may need a large lump sum during the surrender period — for a home renovation, medical emergency, or other major expense.
...
### State Guaranty Fund — Not FDIC

FIAs are backed by the financial strength of the issuing insurance company and your state's insurance guaranty fund — typically covering up to **$250,000 or more per contract, depending on your state**. This is not FDIC insurance, and it is not a federal guarantee.

For retirees with large rollovers, this may mean spreading assets across two carriers to stay within guaranty fund limits. Visit [NOLHGA.com](https://www.nolhga.com) to look up coverage limits for your specific state.

American Equity and F&G both carry strong A.M. Best ratings — verify current ratings with your advisor at the time of your review.
...
- Charles Schwab, *Understanding Sequence of Returns Risk* — [schwab.com](https://www.schwab.com/learn/story/what-is-sequence-of-returns-risk)
