    ...
    <main className="pt-20">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="mt-8 p-6 rounded-lg" style={{ background: '#EBF4FF', border: '1px solid rgba(59,126,200,0.2)' }}>
              <h3 className="font-serif text-xl mb-3 text-navy">Our Vision</h3>
          ...
          <div className="relative">
            <Image src={IMAGES.melinee} alt="All Financial Freedom" width={560} height={560} className="object-cover w-full rounded-lg" style={{ height: 560, objectPosition: 'center 15%' }} />
      ...
      <section className="page-section bg-sky">
        <div className="max-w-3xl">
          ...
          <div className="font-serif font-light mt-6 mb-6 text-blue" style={{ fontSize: '5rem', lineHeight: 1 }}>$68 Trillion</div>
