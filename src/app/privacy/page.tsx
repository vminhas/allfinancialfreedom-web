    ...
    <main className="pt-20">
      ...
      <section style={{ padding: '4rem 5rem', background: '#ffffff' }}>
        <div className="max-w-3xl mx-auto" style={{ fontSize: '0.95rem', lineHeight: 1.85, color: '#374151' }}>
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">3. Third-Party Services</h2>
          <p className="mb-6">
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">4. Data Security</h2>
          <p className="mb-6">
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">5. Your Rights</h2>
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">6. Cookies</h2>
          <p className="mb-6">
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">7. Children&apos;s Privacy</h2>
          <p className="mb-6">
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">8. Changes to This Policy</h2>
          <p className="mb-6">
          ...
          <h2 className="font-serif text-xl text-navy mb-3 mt-8">9. Contact Us</h2>
          <p className="mb-6">
